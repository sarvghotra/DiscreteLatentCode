...
def get_wds_dataset(
    ...
    return dataset, DataInfo(dataloader=dataloader, shared_epoch=shared_epoch)
...
def get_data(args, preprocess_train, epoch=0, tokenizer=None):
    return get_dataset_fn(args.train_data, "webdataset")(
