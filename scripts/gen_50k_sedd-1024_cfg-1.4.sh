...
cd ../dit
sbatch --dependency=${jid} --array=0-195 ./sample_parallelized_imgs_hf.sh --hf-model lavoies/DLC_DiT_L512 --dlc-dir $DLC_DIR/diffused_SEMs --cfg-scale 1.4  --sample-dir $OUT_DIR
